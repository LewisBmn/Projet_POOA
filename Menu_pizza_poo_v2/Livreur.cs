...
namespace Menu_pizza_poo_v2
{
    public class Livreur : Personne, IEquatable<Livreur>
    {
        ...
        static public List<Livreur> LectureFichier()
        {
            ...
            StreamReader line = new StreamReader(@"C:\Users\lewis\source\repos\Menu_pizza_poo_v2\Menu_pizza_poo_v2\bin\Debug\Livreurs.csv");
        ...
        {
            using (var w = new StreamWriter((@"C:\Users\lewis\source\repos\Menu_pizza_poo_v2\Menu_pizza_poo_v2\bin\Debug\Livreurs.csv"), true))
            {
